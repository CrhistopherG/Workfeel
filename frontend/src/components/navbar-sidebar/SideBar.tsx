...
export default function SideBar() {
   return (
      <>
         ...
         <aside id="sidebar-multi-level-sidebar" className=" top-17 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
