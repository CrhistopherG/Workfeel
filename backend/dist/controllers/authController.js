...
const register = async (req, res) => {
    ...
    try {
        ...
        const newUser = await Users_model_1.default.create({ name, password, email });
...
const login = async (req, res) => {
    ...
    try {
        ...
        console.log('[LOGIN] Comparando contraseñas:', `Recibida: ${password}`, `En DB: ${user.password}`, `Coinciden: ${password === user.password}`);
